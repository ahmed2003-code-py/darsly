...
export const VIBE_PROFILES: Record<VibeKey, VibeProfile> = {
  trusted: {
    label: 'Warm & trusted',
    mood: 'A person, not an institution. A parent choosing for their child should feel they have met someone patient and competent. Warmth is the whole brief — everything else serves it.',
    palette:
  ...
  academic: {
    label: 'Academic',
    mood: 'Ordered and unhurried, like a well-set textbook. Nothing is sold loudly because the structure is the argument. A student should be able to see the whole syllabus at a glance.',
    palette:
    ...
    geometry:
      'Sharp: radius 0–6. Hairline or strong borders — structure comes from rules, not shadows. No shadow. No grain.',
    rhythm:
      'Airy or expansive, narrow or standard container. Even rhythm; a syllabus does not crescendo.',
    motion:
      'Calm, with a fade entrance. At most one scroll effect, and sticky-headings is the one that fits.',
    decoration:
  ...
  premium: {
    label: 'Premium',
    mood: 'Expensive restraint. Space is the luxury: fewer things, larger, further apart. It should feel like it costs more because it is worth more, never because it is louder.',
    palette:
    ...
    geometry:
      'Radius 0–8. Hairline borders. No shadow or deep shadow, nothing in between. Grain on, if the page is dark — it is what makes a flat dark page look printed rather than empty.',
    rhythm:
      'Expansive, narrow or standard container. Even or crescendo. Whitespace is the product.',
    motion:
      'Calm or cinematic with a fade or mask-reveal entrance. One scroll effect at most. Slow beats busy.',
    decoration:
  ...
  energetic: {
    label: 'Energetic',
    mood: 'Momentum. Built for a student with an exam in eleven weeks who needs to believe this will work. Results early, proof loud, and the page never stops moving forward.',
    palette:
    ...
    geometry:
      'Radius 10–20, or 0 for a harder edge. Hairline or strong borders. Deep or brutal shadow. Grain only if dark.',
    rhythm:
      'Compact or regular, wide container, alternating bands. Density is part of the urgency.',
    motion:
      'Cinematic or lively. stagger-grid or slide entrance. Use the effects: counters on figures, a progress bar, a marquee.',
    decoration:
