...
export const XP_RULES: XpRuleSeed[] = [
  ...
  {
    id: 'xpr_assignment_high',
    event: 'ASSIGNMENT_GRADED_HIGH',
    xp: 40,
    coins: 20,
    dailyCap: 0,
    perEntityLimit: 1,
  ...
  {
    id: 'xpr_quest_completed',
    event: 'WEEKLY_QUEST_COMPLETED',
    xp: 250,
    coins: 100,
    dailyCap: 0,
    perEntityLimit: 1,
...
export const ACHIEVEMENTS: AchievementSeed[] = [
  {
    ...
    titleAr: 'أول خطوة',
    titleEn: 'First Step',
    descAr: 'اشترك في أول دورة',
    descEn: 'Enroll in your first course',
    metric: 'enrollments',
    threshold: 1,
    xpReward: 50,
    coinReward: 25,
  ...
  },
  {
    ...
    titleAr: 'مواظبة أسبوع',
    titleEn: 'Week Strong',
    descAr: 'حافظ على ٧ أيام متتالية',
    descEn: 'Keep a 7-day streak',
    metric: 'streakBest',
    threshold: 7,
    xpReward: 150,
    coinReward: 75,
  ...
  },
  {
    ...
    titleEn: 'Quiz Ace',
    descAr: 'احصل على ١٠٠٪ في اختبار',
    descEn: 'Score 100% on a quiz',
    metric: 'perfectQuizzes',
    threshold: 1,
    xpReward: 150,
    coinReward: 75,
    titleKey: 'quiz_master',
    sortOrder: 40,
  },
  {
    id: 'ach_first_certificate',
    key: 'first_certificate',
    category: 'LEARNING',
    icon: 'workspace_premium',
    titleAr: 'متخرّج',
    titleEn: 'Graduate',
    descAr: 'احصل على أول شهادة',
    descEn: 'Earn your first certificate',
    metric: 'certificates',
    threshold: 1,
    xpReward: 200,
    coinReward: 100,
  ...
  },
  {
    ...
    titleAr: 'عالِم',
    titleEn: 'Scholar',
    descAr: 'اجمع ٣ شهادات',
    descEn: 'Collect 3 certificates',
    metric: 'certificates',
    threshold: 3,
    xpReward: 400,
    coinReward: 200,
    titleKey: 'top_scholar',
    sortOrder: 60,
  },
  {
    id: 'ach_first_lesson',
  ...
  },
  {
    ...
    titleAr: 'مئة درس',
    titleEn: 'Century',
    descAr: 'أكمِل ١٠٠ درس',
    descEn: 'Complete 100 lessons',
    metric: 'lessonsCompleted',
    threshold: 100,
    xpReward: 800,
    coinReward: 400,
    titleKey: 'knowledge_seeker',
    sortOrder: 80,
  },
  {
    id: 'ach_first_course',
    ...
    descAr: 'أكمِل كورسًا كاملًا',
    descEn: 'Complete a whole course',
  ...
  },
  {
    ...
    icon: 'local_library',
    titleAr: 'خمسة كورسات',
    titleEn: 'Five Courses',
    descAr: 'أكمِل ٥ كورسات',
    descEn: 'Complete 5 courses',
    metric: 'coursesCompleted',
    threshold: 5,
    xpReward: 1000,
    coinReward: 500,
    titleKey: 'course_crusher',
    sortOrder: 100,
  },
  {
    id: 'ach_quiz_master',
    ...
    category: 'PERFORMANCE',
    icon: 'quiz',
    titleAr: 'سيّد الاختبارات',
    titleEn: 'Quiz Master',
    descAr: 'انجح في ٢٠ اختبارًا',
    descEn: 'Pass 20 quizzes',
    metric: 'quizzesPassed',
    threshold: 20,
    xpReward: 500,
    coinReward: 250,
    titleKey: 'quiz_master',
  ...
  },
  {
    ...
    category: 'PERFORMANCE',
    icon: 'grade',
    titleAr: 'خمس درجات كاملة',
    titleEn: 'Flawless Five',
    descAr: 'احصل على ١٠٠٪ في ٥ اختبارات',
    descEn: 'Score 100% on 5 quizzes',
    metric: 'perfectQuizzes',
    threshold: 5,
    xpReward: 500,
    coinReward: 250,
  ...
  },
  {
    ...
    icon: 'calendar_month',
    titleAr: 'شهر كامل',
    titleEn: 'Month Strong',
    descAr: 'حافظ على ٣٠ يومًا متتالية',
    descEn: 'Keep a 30-day streak',
    metric: 'streakBest',
    threshold: 30,
    xpReward: 600,
    coinReward: 300,
    titleKey: 'consistency_king',
    sortOrder: 130,
  },
  {
    id: 'ach_streak_100',
    ...
    titleAr: 'مئة يوم',
    titleEn: 'Unbreakable',
    descAr: 'حافظ على ١٠٠ يوم متتالية',
    descEn: 'Keep a 100-day streak',
    metric: 'streakBest',
    threshold: 100,
    xpReward: 1500,
    coinReward: 750,
  ...
  },
  {
    ...
    titleAr: 'ضمن العشرة',
    titleEn: 'Top 10',
    descAr: 'ادخل أفضل ١٠ في لوحة الصدارة',
    descEn: 'Reach the top 10',
    metric: 'bestRank',
    threshold: 10,
    xpReward: 300,
    coinReward: 150,
  ...
  },
  {
    ...
    category: 'COMPETITION',
    icon: 'emoji_events',
    titleAr: 'منصة التتويج',
    titleEn: 'Podium',
    descAr: 'ادخل أفضل ٣ في لوحة الصدارة',
  ...
  },
  {
    ...
    titleAr: 'الأول',
    titleEn: 'Number One',
    descAr: 'كن الأول في لوحة الصدارة',
    descEn: 'Finish first on a leaderboard',
    metric: 'bestRank',
    threshold: 1,
    xpReward: 1000,
    coinReward: 500,
    titleKey: 'darsly_legend',
    sortOrder: 170,
  },
  {
    id: 'ach_explorer_3',
    ...
    titleAr: 'مستكشف',
    titleEn: 'Explorer',
    descAr: 'ابدأ في ٣ كورسات مختلفة',
    descEn: 'Start 3 different courses',
    metric: 'enrollments',
    threshold: 3,
    xpReward: 200,
    coinReward: 100,
  ...
  {
    id: 'ach_multi_subject',
    key: 'multi_subject',
    category: 'EXPLORATION',
    icon: 'category',
    titleAr: 'متعدد المواد',
    titleEn: 'Well Rounded',
    descAr: 'تعلّم في مادتين مختلفتين',
    descEn: 'Learn across 2 subjects',
  ...
  },
  {
    ...
    titleAr: 'طائر الصباح',
    titleEn: 'Early Bird',
    descAr: 'ذاكر ٥ مرات قبل الثامنة صباحًا',
    descEn: 'Study 5 times before 8am',
  ...
  },
  {
    ...
    titleAr: 'بومة الليل',
    titleEn: 'Night Owl',
    descAr: 'ذاكر ٥ مرات بعد منتصف الليل',
    descEn: 'Study 5 times after midnight',
  ...
  },
  {
    ...
    category: 'SPECIAL',
    icon: 'weekend',
    titleAr: 'محارب الإجازة',
    titleEn: 'Weekend Warrior',
    descAr: 'ذاكر في ٥ عطلات',
    descEn: 'Study on 5 weekends',
    metric: 'weekendSessions',
    threshold: 5,
    xpReward: 200,
    coinReward: 100,
    titleKey: 'speed_solver',
    sortOrder: 220,
  },
  {
    id: 'ach_assignments_10',
    key: 'assignments_10',
    category: 'LEARNING',
    icon: 'assignment_turned_in',
    titleAr: 'ملتزم بالواجبات',
    titleEn: 'On Top of It',
    descAr: 'سلّم ١٠ واجبات',
    descEn: 'Submit 10 assignments',
    metric: 'assignmentsDone',
    threshold: 10,
    xpReward: 300,
    coinReward: 150,
    titleKey: null,
  ...
  },
  {
    ...
    icon: 'sensors',
    titleAr: 'حاضر دائمًا',
    titleEn: 'Always There',
    descAr: 'احضر ٥ جلسات مباشرة',
    descEn: 'Attend 5 live sessions',
    metric: 'liveAttended',
    threshold: 5,
    xpReward: 300,
    coinReward: 150,
  ...
  {
    id: 'ach_challenge_ace',
    key: 'challenge_ace',
    category: 'PERFORMANCE',
    icon: 'stars',
    titleAr: 'بطل التحديات',
    titleEn: 'Challenge Ace',
    descAr: 'احصل على درجة كاملة في تحدي',
    descEn: 'Score a perfect challenge',
    metric: 'perfectChallenges',
    threshold: 1,
    xpReward: 150,
    coinReward: 75,
    titleKey: null,
  ...
  {
    id: 'ach_challenge_ranked_10',
    key: 'challenge_ranked_10',
    category: 'COMPETITION',
    icon: 'military_tech',
    titleAr: 'محارب التحديات',
    titleEn: 'Challenge Warrior',
    descAr: 'أنهِ ١٠ تحديات تنافسية',
    descEn: 'Finish 10 ranked Challenges',
    metric: 'challengesWon',
    threshold: 10,
    xpReward: 400,
    coinReward: 200,
    titleKey: null,
...
export const TITLES: TitleSeed[] = [
  ...
  {
    key: 'course_crusher',
    labelAr: 'قاهر الكورسات',
    labelEn: 'Course Crusher',
    icon: 'local_fire_department',
    sortOrder: 20,
  },
  {
    key: 'knowledge_seeker',
    labelAr: 'باحث عن المعرفة',
    labelEn: 'Knowledge Seeker',
    icon: 'travel_explore',
    sortOrder: 30,
  },
  {
    key: 'consistency_king',
    labelAr: 'ملك المواظبة',
    labelEn: 'Consistency King',
    icon: 'calendar_month',
    sortOrder: 40,
  },
  {
    key: 'top_scholar',
    labelAr: 'الطالب الأول',
    labelEn: 'Top Scholar',
    icon: 'school',
    sortOrder: 50,
  },
  {
    key: 'speed_solver',
    labelAr: 'سريع الحل',
    labelEn: 'Speed Solver',
    icon: 'bolt',
    sortOrder: 60,
  },
  {
    key: 'darsly_legend',
    labelAr: 'أسطورة درسلي',
    labelEn: 'Darsly Legend',
    icon: 'auto_awesome',
    sortOrder: 70,
  },
];
...
export const REWARDS: RewardSeed[] = [
  {
    id: 'rwd_streak_freeze',
    key: 'streak_freeze',
    category: 'PROGRESS',
    kind: 'STREAK_FREEZE',
    icon: 'ac_unit',
    titleAr: 'تجميد السلسلة',
    titleEn: 'Streak Freeze',
    descAr: 'يحمي سلسلتك ليوم واحد لو فاتك المذاكرة',
    descEn: 'Protects your streak for one missed day',
    costCoins: 150,
    payload: { count: 1 },
    sortOrder: 10,
  },
  {
    ...
    kind: 'XP_BOOST',
    icon: 'bolt',
    titleAr: 'مضاعفة النقاط ×٢',
    titleEn: '2× XP Boost',
    descAr: 'ضاعِف نقاط أول ٣ دروس تكمّلها',
    descEn: 'Doubles the XP of your next 3 lessons',
    costCoins: 300,
    payload: { multiplier: 2, lessons: 3 },
    sortOrder: 20,
  },
  {
    id: 'rwd_xp_boost_15',
    ...
    kind: 'XP_BOOST',
    icon: 'trending_up',
    titleAr: 'مضاعفة النقاط ×١.٥',
    titleEn: '1.5× XP Boost',
    descAr: 'زوّد نقاط أول ٥ دروس بنسبة ٥٠٪',
    descEn: '+50% XP on your next 5 lessons',
    costCoins: 180,
    payload: { multiplier: 1.5, lessons: 5 },
    sortOrder: 30,
  },
  {
    id: 'rwd_title_seeker',
    key: 'title_knowledge_seeker',
    category: 'PROFILE',
    kind: 'TITLE',
    icon: 'travel_explore',
    titleAr: 'لقب: باحث عن المعرفة',
    titleEn: 'Title: Knowledge Seeker',
    descAr: 'أضف اللقب لملفك الشخصي',
    descEn: 'Unlock this title for your profile',
    costCoins: 400,
    payload: { titleKey: 'knowledge_seeker' },
    sortOrder: 40,
  },
  {
    id: 'rwd_title_speed',
    key: 'title_speed_solver',
    category: 'PROFILE',
    kind: 'TITLE',
    icon: 'bolt',
    titleAr: 'لقب: سريع الحل',
    titleEn: 'Title: Speed Solver',
    descAr: 'أضف اللقب لملفك الشخصي',
    descEn: 'Unlock this title for your profile',
    costCoins: 400,
    payload: { titleKey: 'speed_solver' },
    sortOrder: 50,
  },
];
