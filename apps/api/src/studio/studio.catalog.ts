...
export const CATALOG: CatalogSeed[] = [
  ...
  theme(
    ...
    18,
    {
      ...
      motion: 'expressive',
      icons: { fill: 1, weight: 500 },
      cardLayout: 'imageFirst',
      typeScale: 'default',
    },
  ),
  ...
  style(
    ...
    'أزرار بيضاوية',
    'Pill buttons',
    'حواف دايرة بالكامل على كل زرار في التطبيق.',
    'Fully rounded edges on every button in the app.',
    40,
    30,
  ),
  style(
    ...
    'أزرار حادة',
    'Sharp buttons',
    'حواف شبه مستقيمة — شكل أكثر جدية.',
    'Near-square edges, for a stricter look.',
    40,
    31,
  ),
  style(
    ...
    'أزرار بارزة',
    'Raised buttons',
    'ظل خفيف تحت كل زرار، كإنه مرفوع عن الصفحة.',
    'A soft shadow under every button, lifting it off the page.',
    60,
    32,
  ),
  style(
    ...
    'كروت ناعمة',
    'Soft cards',
    'كورنرز أوسع وخلفية أهدى لكل كارت.',
    'Wider corners and a quieter background on every card.',
    60,
    33,
  ),
  style(
    ...
    'كروت ورق',
    'Paper cards',
    'من غير ظل ولا كورنرز — مسطّح زي الورق.',
    'No shadow and barely any corner — flat, like paper.',
    60,
    34,
  ),
  ...
  style(
    ...
    'كروت زجاج',
    'Frosted cards',
    'شفافية وضبابية خفيفة — اللي تحت الكارت بيبان من ورا.',
    'Translucent and lightly blurred — what is behind shows through.',
    120,
    35,
  ),
  ...
  style(
    ...
    'شريط أيقونات',
    'Icon rail',
    'القائمة تبقى عمود رفيع من الأيقونات، والاسم يظهر لما تقف عليها.',
    'The sidebar becomes a slim column of icons; the name shows on hover.',
    60,
    36,
  ),
  style(
    ...
    'قائمة بلا إطار',
    'Chromeless sidebar',
    'من غير خلفية ولا حد — الصفحة بتكمل وراها.',
    'No background and no edge — the page runs on behind it.',
    60,
    37,
  ),
  style(
    ...
    'قائمة عائمة',
    'Floating sidebar',
    'منفصلة عن الحافة، مدوّرة، ومرفوعة بظل.',
    'Detached from the edge, rounded, and lifted on a shadow.',
    80,
    38,
  ),
  style(
    ...
    'من غير قائمة',
    'No sidebar',
    'التنقّل الأساسي يطلع في الهيدر والباقي ورا زرار القائمة.',
    'The primary destinations move into the header; the rest sit behind the menu button.',
    100,
    39,
  ),
  style(
    ...
    'قائمة زجاجية',
    'Glass sidebar',
    'شفافة وضبابية — الخلفية بتبان من وراها.',
    'Translucent and blurred — the backdrop shows through.',
    120,
    40,
  ),
  style(
    ...
    'هيدر شفاف',
    'Transparent header',
    'من غير خلفية ولا خط تحته، والبحث أيقونة لحد ما تدوس.',
    'No background and no line beneath; the search is an icon until pressed.',
    60,
    41,
  ),
  style(
    ...
    'هيدر قصير',
    'Compact header',
    'أقصر بالتلت، والبحث أيقونة لحد ما تدوس.',
    'A third shorter; the search is an icon until pressed.',
    60,
    42,
  ),
  style(
    ...
    'Centered search',
    'البحث ياخد النص كله.',
    'The search takes the whole middle.',
    60,
    43,
  ),
  style(
    ...
    'هيدر عائم',
    'Floating header',
    'منفصل عن الحافة، كبسولة مدوّرة بظل.',
    'Detached from the edge — a rounded capsule on a shadow.',
    80,
    44,
  ),
  style(
    ...
    'هيدر باسم الصفحة',
    'Tall header',
    'أعلى، وفيه اسم الصفحة اللي انت فيها.',
    'Taller, carrying the name of the page you are on.',
    100,
    45,
  ),
  style(
    ...
    'هيدر زجاجي',
    'Glass header',
    'شفاف وضبابي — الصفحة بتبان من وراه وهي بتتحرك.',
    'Translucent and blurred — the page shows through as it scrolls.',
    120,
    46,
  ),
  ...
  style(
    ...
    'وهج',
    'Glow',
    'هالة خفيفة حوالين الحاجة المختارة في القائمة.',
    'A soft halo around whatever is selected in the menu.',
    130,
    52,
    { requiredLevel: 2 },
  ),
  style(
    ...
    'إطار برونزي',
    'Bronze frame',
    'حلقة برونزي حوالين صورتك في كل مكان.',
    'A bronze ring around your picture, everywhere it appears.',
    70,
    50,
  ),
  style(
    ...
    'إطار فضي',
    'Silver frame',
    'حلقة فضي حوالين صورتك في كل مكان.',
    'A silver ring around your picture, everywhere it appears.',
    100,
    51,
  ),
  style(
    ...
    'إطار ذهبي',
    'Gold frame',
    'حلقة ذهب حوالين صورتك في كل مكان.',
    'A gold ring around your picture, everywhere it appears.',
    220,
    53,
    { requiredLevel: 2 },
  ),
  style(
    ...
    'إطار برق',
    'Lightning frame',
    'حلقة صفرا لامعة حوالين صورتك.',
    'A bright yellow ring around your picture.',
    300,
    54,
    { requiredLevel: 3 },
  ),
  style(
    ...
    'إطار ألماس',
    'Diamond frame',
    'حلقة سماوي بهالة حواليها.',
    'A cyan ring with a halo around it.',
    550,
    55,
    { requiredLevel: 5 },
  ),
  ...
  style(
    ...
    'Not for sale. It arrives with the "Scholar" achievement — three certificates.',
    0,
    56,
  ...
  style(
    ...
    'Not for sale. It arrives with the "A whole month" achievement — a 30-day streak.',
    0,
    57,
  ...
  style(
    ...
    'Not for sale, and no amount of coins will do. A hundred-day streak, and nothing else.',
    0,
    58,
