...
- **التسجيل والترانسكريبت**: الاتنين متحقَّق منهم على الحساب الحالي. التسجيل
  بيبدأ من المتصفّح (توكن المالك هو اللي بيسمح بيه) والترانسكريبت بيبدأ معاه في
  نفس اللحظة — لإن نية المدرّس واحدة: يسجّل الحصة دي. لو الترانسكريبت مش متاح
  على الخطة، التسجيل بيفضل شغّال والملخّص هو اللي بيقول إنه مالقاش نص.
