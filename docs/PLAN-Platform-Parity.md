...
> **ملحوظة**: الخطة دي اتكتبت قبل ما يخلص شغل كتير. حالة النهاردة الحقيقية في
> [`../NEXT-SESSION.md`](../NEXT-SESSION.md) — فيه حاجات خلصت هنا مش مكتوبة في
> الجدول، وحاجات تانية (زي استوديو الطالب) مكنتش في الخطة أصلاً.

## تتبّع التقدّم
| Phase | الفيتشر | الحالة |
|---|---|---|
| 0 | قشرة احترافية + وصول + دارك مود | ✅ دارك مود + حدود تباين + لياوت الموبايل خلصوا |
| 1.1 | محفظة طالب: رصيد + شحن بإثبات + سجل + صفحة طالب + مراجعة أدمن | ✅ منشور |
| 1.2 | الشراء من رصيد المحفظة (خروج فلوس) | ✅ منشور — الطالب بيختار يدفع من المحفظة، وماينفعش يتخصم من غير اختياره |
| 1.3 | شحن تلقائي بمطابقة الليسنر | ✅ منشور — ودفع بالكارت كمان عن طريق XPay |
