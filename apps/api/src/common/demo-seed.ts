...
const TEACHERS = [
  {
    name: 'أ. خالد عبدالرحمن',
    slug: 'khaled-academy',
    subject: 'math',
    color: '#4A32C9',
    tagline: 'الرياضيات ببساطة ووضوح',
  },
  {
    name: 'أ. نورة الخالد',
    slug: 'noura-academy',
    subject: 'chem',
    color: '#0F766E',
    tagline: 'الكيمياء بشكل تفاعلي وممتع',
  },
  {
    name: 'أ. أحمد فؤاد',
    slug: 'ahmed-academy',
    subject: 'physics',
    color: '#B45309',
    tagline: 'الفيزياء من واقع الحياة',
  },
  {
    name: 'أ. منى سمير',
    slug: 'mona-academy',
    subject: 'bio',
    color: '#15803D',
    tagline: 'الأحياء خطوة بخطوة',
  },
  {
    name: 'أ. يوسف حسن',
    slug: 'youssef-academy',
    subject: 'english',
    color: '#BE123C',
    tagline: 'الإنجليزية بثقة وطلاقة',
  },
  {
    name: 'أ. سلمى إبراهيم',
    slug: 'salma-academy',
...
const REVIEW_COMMENTS = [
  'شرح ممتاز وواضح',
  'استفدت كتير من الدورة',
  'أفضل مدرّس',
  'المحتوى منظّم جداً',
  'أسلوب رائع في التبسيط',
];
...
const QUIZ_BANK: Record<string, SeedQuestion[]> = {
  math: [
    {
      ...
      correctOptionId: 'b',
      explanation: 'الضرب أولاً: ٣×٤=١٢ ثم +٢ = ١٤.',
      points: 2,
    },
    {
      type: 'TRUE_FALSE',
      prompt: 'مجموع زوايا المثلث يساوي ١٨٠ درجة.',
      options: TF(),
      correctOptionId: 'true',
      explanation: 'صحيح لكل مثلث في المستوى.',
      points: 1,
    },
    {
      type: 'SHORT_ANSWER',
      prompt: 'اشرح نظرية فيثاغورس بإيجاز.',
      options: [],
  ...
  physics: [
    {
      ...
      correctOptionId: 'a',
      explanation: 'القوة تُقاس بالنيوتن (N).',
      points: 2,
    },
    {
      type: 'TRUE_FALSE',
      prompt: 'سرعة الضوء في الفراغ ثابتة.',
      options: TF(),
      correctOptionId: 'true',
      explanation: 'ثابتة ≈ ٣×١٠⁸ م/ث.',
      points: 1,
    },
    {
      type: 'SHORT_ANSWER',
      prompt: 'عرّف قانون نيوتن الأول للحركة.',
      options: [],
      correctOptionId: null,
      explanation: '',
      points: 3,
  ...
  chem: [
    {
      type: 'MCQ',
      prompt: 'ما الرمز الكيميائي للماء؟',
      options: [
        { id: 'a', text: 'CO₂' },
        { id: 'b', text: 'O₂' },
        { id: 'c', text: 'H₂O' },
      ...
      correctOptionId: 'c',
      explanation: 'الماء يتكوّن من ذرتي هيدروجين وذرة أكسجين.',
      points: 2,
    },
    {
      type: 'TRUE_FALSE',
      prompt: 'العدد الذري يساوي عدد البروتونات في النواة.',
      options: TF(),
      correctOptionId: 'true',
      explanation: 'صحيح — العدد الذري = عدد البروتونات.',
      points: 1,
    },
    {
      type: 'SHORT_ANSWER',
      prompt: 'ما الفرق بين العنصر والمركب؟',
      options: [],
      correctOptionId: null,
      explanation: '',
      points: 3,
  ...
  bio: [
    {
      type: 'MCQ',
      prompt: 'أي عضية مسؤولة عن إنتاج الطاقة في الخلية؟',
      options: [
        { id: 'a', text: 'النواة' },
        { id: 'b', text: 'الميتوكوندريا' },
        { id: 'c', text: 'الرايبوسوم' },
        { id: 'd', text: 'جهاز جولجي' },
      ],
      correctOptionId: 'b',
      explanation: 'الميتوكوندريا هي محطة توليد الطاقة.',
      points: 2,
    },
    {
      type: 'TRUE_FALSE',
      prompt: 'الخلية النباتية تحتوي على جدار خلوي.',
      options: TF(),
      correctOptionId: 'true',
      explanation: 'صحيح — الجدار الخلوي من السليولوز.',
      points: 1,
    },
    {
      type: 'SHORT_ANSWER',
      prompt: 'اشرح عملية البناء الضوئي بإيجاز.',
      options: [],
      correctOptionId: null,
      explanation: '',
      points: 3,
  ...
  arabic: [
    {
      type: 'MCQ',
      prompt: 'ما إعراب «الطالبُ» في جملة: نجح الطالبُ؟',
      options: [
      ...
      correctOptionId: 'a',
      explanation: 'فاعل مرفوع وعلامة رفعه الضمة.',
      points: 2,
    },
    {
      type: 'TRUE_FALSE',
      prompt: 'الفعل الماضي مبني دائماً.',
      options: TF(),
      correctOptionId: 'true',
      explanation: 'صحيح — الفعل الماضي مبني.',
      points: 1,
    },
    {
      type: 'SHORT_ANSWER',
      prompt: 'اذكر أنواع الجموع في اللغة العربية مع مثال.',
      options: [],
      correctOptionId: null,
      explanation: '',
      points: 3,
  ...
  english: [
    ...
    {
      type: 'TRUE_FALSE',
      prompt: '“They is happy” is grammatically correct.',
      options: TF(),
      correctOptionId: 'false',
      explanation: 'It should be “They are happy”.',
      points: 1,
    },
    {
      type: 'SHORT_ANSWER',
      prompt: 'Write one sentence using the present perfect tense.',
      options: [],
      correctOptionId: null,
      explanation: '',
      points: 3,
...
const CHAT_LINES = [
  [
    'عندي سؤال في الدرس الثالث، ممكن توضّح؟',
    'أكيد، الفكرة إن…',
    'تمام، وصلت المعلومة، شكراً جزيلاً!',
  ],
  ['أستاذ، الامتحان صعب شوية 😅', 'ركّز على الأمثلة المحلولة وهتلاقيه أسهل.', 'حاضر، هراجع تاني.'],
  [
    'متى الحصة القادمة المباشرة؟',
    'مجدولة الأسبوع الجاي، هتلاقيها في صفحة البث.',
    'جميل، هحجز مكاني.',
  ],
];
...
export async function seedDatabase(prisma: Db, log: (m: string) => void = () => {}) {
  ...
  for (let i = 0; i < SUBJECTS.length; i++) {
    const s = await prisma.subject.upsert({
      ...
      create: {
        ...
        nameAr: SUBJECTS[i].nameAr,
        nameEn: SUBJECTS[i].nameEn,
        icon: SUBJECTS[i].icon,
        sortOrder: i,
        track: SUBJECTS[i].track,
      },
    });
  ...
  await prisma.platformPaymentAccount.createMany({
    data: [
      {
        method: 'INSTAPAY',
        label: 'إنستاباي درسلي',
        handle: 'darsly@instapay',
        instructions: 'حوّل ثم ارفع لقطة الشاشة',
        sortOrder: 0,
      },
      {
        method: 'VODAFONE_CASH',
        label: 'فودافون كاش درسلي',
        handle: '01000000000',
        instructions: 'حوّل على المحفظة ثم ارفع الإثبات',
        sortOrder: 1,
      },
    ],
  });
  ...
  for (let i = 0; i < totalStudents; i++) {
    ...
    const user = await prisma.user.create({
      data: {
        role: 'STUDENT',
        email: `student${i + 1}@darsly.app`,
        passwordHash: hash,
        fullName: name,
        avatarUrl: avatar(i + 12),
      },
    });
    const profile = await prisma.studentProfile.create({
      data: {
        userId: user.id,
        gradeId: pick(grades),
        currentStreak: rand(12),
        longestStreak: rand(30),
      },
    });
  ...
  for (let ti = 0; ti < TEACHERS.length; ti++) {
    ...
    const tUser = await prisma.user.create({
      data: {
        role: 'TEACHER',
        email: `teacher${ti + 1}@darsly.app`,
        passwordHash: hash,
        fullName: T.name,
        avatarUrl: avatar(ti + 1),
      },
    });
    const tp = await prisma.teacherProfile.create({
      data: {
        ...
        slug: T.slug,
        bio: T.tagline,
        subjects: { create: [{ subjectId: subjects[T.subject] }] },
        status: 'APPROVED',
        verifiedAt: new Date(),
    ...
    const academy = await prisma.academy.create({
      data: {
        id: tp.id,
        slug: T.slug,
        name: T.name.replace('أ. ', 'أكاديمية '),
        status: 'ACTIVE',
        ownerUserId: tUser.id,
        tagline: T.tagline,
        logoUrl: avatar(ti + 1),
        coverUrl: cover,
    ...
    for (let ci = 0; ci < COURSE_TEMPLATES.length; ci++) {
      ...
      const course = await prisma.course.create({
        data: {
          tenantId: academy.id,
          title: `${subjName} — ${CT.suffix}`,
          description: `دورة ${CT.suffix} في ${subjName} مع ${T.name}. محتوى منظّم بالفيديو والاختبارات والواجبات.`,
          subjectId: subjects[T.subject],
          grades: { create: [{ gradeId: grades[(ti + ci) % grades.length] }] },
          status: 'PUBLISHED',
          pricingModel: CT.model as any,
          priceCents: CT.price,
          thumbnailUrl: cover,
          defaultViewsCap: 3,
        },
      ...
      const u1 = await prisma.courseUnit.create({
        data: { courseId: course.id, title: 'الوحدة الأولى — التأسيس', sortOrder: 0 },
      });
      for (let l = 0; l < 3; l++) {
        const lesson = await prisma.lesson.create({
          data: {
            unitId: u1.id,
            title: `الدرس ${l + 1}: مقدمة ${subjName}`,
            type: 'VIDEO',
            sortOrder: l,
            durationSec: 480 + rand(600),
            isFreePreview: l === 0,
          },
        });
        ...
        if (l === 0) {
          ...
          await prisma.attachment.create({
            data: {
              lessonId: lesson.id,
              fileName: `ورقة عمل — ${subjName}.txt`,
              storageKey: key,
              mimeType: 'text/plain',
              sizeBytes: WORKSHEET(subjName).length,
              downloadable: true,
            },
          });
          stats.attachments++;
      ...
      const u2 = await prisma.courseUnit.create({
        data: { courseId: course.id, title: 'الوحدة الثانية — التطبيق', sortOrder: 1 },
      });
      for (let l = 0; l < 2; l++) {
        const lesson = await prisma.lesson.create({
          data: {
            unitId: u2.id,
            title: `الدرس ${l + 4}: تطبيقات ${subjName}`,
            type: 'VIDEO',
            sortOrder: l,
            durationSec: 480 + rand(600),
          },
      ...
      const asgLesson = await prisma.lesson.create({
        data: {
          unitId: u2.id,
          title: 'واجب الوحدة الثانية',
          type: 'ASSIGNMENT',
          sortOrder: 2,
          durationSec: 0,
        },
      ...
      const assignment = await prisma.assignment.create({
        data: {
          lessonId: asgLesson.id,
          prompt: ASSIGN_PROMPT[T.subject],
      ...
      for (const c of chosen) {
        ...
        if (c.priceCents > 0 && chance(0.7)) {
          ...
          const payment = await prisma.payment.create({
            data: {
              ...
              status: 'PAID',
              gateway: 'manual',
              method: pick(['INSTAPAY', 'VODAFONE_CASH']) as any,
              paidAt: new Date(),
              settledAt: new Date(),
            },
          });
            ...
            data: {
              ...
              entries: {
                create: [
                  ...
                  {
                    account: `teacher:${academy.id}:balance`,
                    direction: 'CREDIT',
                    amountCents: net,
                    tenantId: academy.id,
                  },
        ...
        for (let li = 0; li < videoLessons.length; li++) {
          ...
          await prisma.lessonProgress
            .create({
              data: {
                studentId: st.id,
                lessonId: videoLessons[li],
                watchedPct: done ? 100 : 20 + rand(60),
                lastPositionSec: 60 + rand(400),
          ...
          await prisma.certificate
            .create({
              data: {
                studentId: st.id,
                courseId: c.id,
                serial: `DRS-CERT-2026-${String(stats.certificates + 1).padStart(6, '0')}`,
                verifyToken: token(),
              },
            })
            .catch(() => undefined);
          ...
          await prisma.quizAttempt
            .create({
              data: {
                ...
                studentId: st.id,
                answers: { q1: 'b' } as any,
                scorePct: passed ? 70 + rand(30) : 20 + rand(30),
                passed,
        ...
        if (chance(0.5) && (c as any).assignmentId) {
          ...
          await prisma.assignmentSubmission
            .create({
              data: {
                assignmentId: (c as any).assignmentId,
                studentId: st.id,
                body: 'هذه إجابتي على الواجب المطلوب مع خطوات الحل.',
                score: graded ? 60 + rand(40) : null,
                feedback: graded ? 'إجابة جيدة، انتبه للخطوة الأخيرة.' : null,
        ...
        for (let mi = 0; mi < lines.length; mi++) {
          ...
          await prisma.chatMessage.create({
            data: {
              ...
              body: lines[mi],
              readAt: mi < lines.length - 1 ? new Date() : null,
            },
          });
        }
    ...
    const cross = students.slice(
      ((ti + 1) % TEACHERS.length) * STUDENTS_PER,
      ((ti + 1) % TEACHERS.length) * STUDENTS_PER + 6,
    );
    for (const st of cross) {
      await prisma.academyMembership.upsert({
        where: { userId_academyId: { userId: st.userId, academyId: academy.id } },
        update: {},
        create: {
          userId: st.userId,
          academyId: academy.id,
      ...
      await prisma.enrollment.upsert({
        where: { studentId_courseId: { studentId: st.id, courseId: c.id } },
        update: {},
        create: {
          studentId: st.id,
          courseId: c.id,
    ...
    for (let lv = 0; lv < 2; lv++) {
      const session = await prisma.liveSession.create({
        data: {
          tenantId: academy.id,
          courseId: courses[lv % courses.length].id,
          title: `بث مباشر: مراجعة ${subjName} (${lv + 1})`,
          description: 'حصة مباشرة لمراجعة أهم النقاط والإجابة على الأسئلة.',
          startsAt: new Date(Date.now() + (lv + 1) * 2 * 86_400_000),
          durationMin: 60,
          capacity: 50,
          joinUrl: 'https://meet.darsly.app/demo',
        },
      });
      for (const st of cohort.slice(0, 4 + rand(4))) {
        await prisma.liveBooking
          .create({ data: { sessionId: session.id, studentId: st.id } })
          .catch(() => undefined);
      }
      stats.live++;
    }
