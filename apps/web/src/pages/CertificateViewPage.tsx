  ...
  return (
    <div className="min-h-screen bg-surface-container px-4 py-10 print:bg-white">
      <div className="mx-auto max-w-3xl">
        ...
        <div
          className="relative overflow-hidden rounded-3xl border-4 border-primary/30 bg-surface-container-lowest p-10 text-center shadow-modal sm:p-16"
        ...
        >
          ...
          <p className="mb-1 font-heading text-lg font-extrabold tracking-wide text-primary">
            درسلي · Darsly
          </p>
          <span className="material-symbols-outlined my-4 text-6xl text-primary">
            workspace_premium
          </span>
          ...
          <div className="mt-10 flex items-end justify-between gap-4 text-start">
            ...
            <div className="text-end">
              <p className="border-t border-outline pt-1 font-mono text-sm" dir="ltr">
                {data.serial}
              </p>
